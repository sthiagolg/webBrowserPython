...
with open("./addBlocker/easylist.txt") as f:
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        agent = "New Privacy Browser by Thiago Almeida"
        ...
        home_btn = QAction(QIcon(os.path.join('images', 'duckduckgo.png')), "DuckDuckGo", self)
        home_btn.setStatusTip("Go Search")
        home_btn.triggered.connect(self.navigate_google)
        navtb.addAction(home_btn)

        yt_btn = QAction(QIcon(os.path.join('images', 'yt-icon.png')), "YouTube", self)
        yt_btn.setStatusTip("Go YouTube")
        yt_btn.triggered.connect(self.navigate_youtube)
        navtb.addAction(yt_btn)

        download_btn = QAction(QIcon(os.path.join('images', 'ytDownload.png')), "Download YT video", self)
        download_btn.setStatusTip("Download YouTube video")
        download_btn.triggered.connect(self.download_yt)
    ...
    def update_title(self):
        ...
        self.setWindowTitle("%s - Meu Browser" % title)
    ...
    def navigate_google(self):
        QWebEngineProfile.defaultProfile().cookieStore().deleteAllCookies()
        q=QUrl("https://www.duckduckgo.com")
        #q.setRawHeader("User-Agent","Thiago")
    ...
    def navigate_to_url(self):  # Does not receive the Url
        #self.browser.userAgentForUrl="thigo"
        #print("USER AGENTTTTTT:",self.browser.userAgentForUrl)
        QWebEngineProfile.defaultProfile().cookieStore().deleteAllCookies()
    ...
    def download_yt(self):
        urlVideo = self.urlbar.text()
        ydl_opts = {}
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            print("URL:  "+str(urlVideo))
            ydl.download([str(urlVideo)])
...
QWebEngineProfile.defaultProfile().cookieStore().deleteAllCookies()
#QWebEngineProfile.setHttpUserAgent(self,"thiagoooooo")
#etHttpUserAgent("test browser")
